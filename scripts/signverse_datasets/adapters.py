...
def _candidate_from_media(path: Path, source: DatasetSource) -> CandidateAsset:
    ...
    return CandidateAsset(
        ...
        language=str(metadata.get("language") or source.language).strip(),
        region=str(metadata.get("region") or source.region).strip(),
...
def _candidate_from_mapping(
    ...
    return CandidateAsset(
        ...
        language=_mapped(row, source, "language") or source.language,
        region=_mapped(row, source, "region") or source.region,
